//
//  AppDelegate.m
//  MSDynamicsDrawerExample
//
//  Created by chuguangming on 15/1/22.
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.jumperworker.MSDynamicsDrawerExample" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MSDynamicsDrawerExample" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MSDynamicsDrawerExample.sqlite"];
    NSError *error = nil;
